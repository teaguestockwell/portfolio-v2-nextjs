...
export const Svgs = {
  ...
  linkedin: (name: string | undefined = 'Linkedin') => (
    <Svg
      name={name}
      paths={
        <>
          ...
          <path
            fill="#fff"
            d="M43 3.162v36.676A3.162 3.162 0 0 1 39.838 43H3.162A3.162 3.162 0 0 1 0 39.838V3.162A3.162 3.162 0 0 1 3.162 0h36.676A3.162 3.162 0 0 1 43 3.162ZM12.647 16.441H6.324V36.676h6.324Zm.569-6.956A3.642 3.642 0 0 0 9.599 5.818H9.485a3.668 3.668 0 0 0 0 7.335h0a3.642 3.642 0 0 0 3.731-3.554ZM36.676 24.384c0-6.083-3.87-8.448-7.715-8.448a7.209 7.209 0 0 0-6.399 3.263H22.385V16.441H16.441V36.676h6.324V25.914a4.199 4.199 0 0 1 3.794-4.528h.24c2.011 0 3.503 1.265 3.503 4.452V36.676h6.324Z"
          ></path>{' '}
        </>
      }
    />
  ),
  github: (name: string | undefined = 'Github') => (
    <Svg
      name={name}
      paths={
        <>
          ...
          <path
            fill="#fff"
            d="M21.647 0C9.687 0 0 9.687 0 21.647c0 9.579 6.196 17.669 14.801 20.538 1.082.189 1.488-.46 1.488-1.028 0-.514-.027-2.219-.027-4.032-5.439 1.001-6.846-1.326-7.279-2.544-.244-.622-1.299-2.544-2.219-3.058-.758-.406-1.84-1.407-.027-1.434 1.705-.027 2.922 1.569 3.328 2.219 1.948 3.274 5.06 2.354 6.305 1.786.189-1.407.758-2.354 1.38-2.895-4.816-.541-9.849-2.408-9.849-10.688 0-2.354.839-4.302 2.219-5.818-.216-.541-.974-2.76.216-5.736 0 0 1.813-.568 5.953 2.219 1.732-.487 3.572-.731 5.412-.731 1.84 0 3.68.244 5.412.731 4.14-2.814 5.953-2.219 5.953-2.219 1.191 2.976.433 5.195.216 5.736 1.38 1.515 2.219 3.436 2.219 5.818 0 8.307-5.06 10.147-9.876 10.688.785 .676 1.461 1.975 1.461 4.005 0 2.895-.027 5.222-.027 5.953 0 .568.406 1.245 1.488 1.028A21.682 21.682 0 0 0 43.294 21.647c0-11.96-9.687-21.647-21.647-21.647Z"
          ></path>{' '}
        </>
      }
    />
