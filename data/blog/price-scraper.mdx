...
Great! Now that there is an HTTP server that uses a headed browser to load a webpage and parse the structured data into product meta data. Let's pack this up so many instance of it can be deployed behind an HTTPS load balancer when the repo is pushed to Github! I encourage you to take a look at:
...
[How im using this service](https://github.com/teaguestockwell/buildable-readme) in a [social media platform](https://hello-next-auth.vercel.app/) to explore projects by the products used to build them.
